...
class ConversationDataProvider : NSObject {
    ...
    init(tableView: UITableView, conversationId: String) {
        ...
        self.fetchedResultsController = NSFetchedResultsController<Message>(fetchRequest: fetchRequest, managedObjectContext: CoreDataStack.instance.mainContext, sectionNameKeyPath: nil, cacheName: nil)
